...
public final class FormIdNames {
  public static final String VENDOR_ID = "vendorID";
  public static final String ACCOUNT_ID = "accountID";
  public static final String LEGACY_CUSTOMER_ID = "legacy-customer-id";
  public static final String LEGACY_CUSTOMER_ID_QUERY = "legacyCustomerID";
  public static final String NEXT_GEN_CUSTOMER_ID = "next-gen-customer-id";
  public static final String NEXT_GEN_CUSTOMER_ID_QUERY = "nextGenCustomerID";
